...
public class TestWorkers {
    ...
    @Test
    public void StackTest() throws ParserException, WorkerException {
    ...
    @Test
    public void DivTest() throws ParserException, WorkerException {
    ...
    @Test
    public void MinusTest() throws ParserException, WorkerException {
        Stack<Double> localStack = new Stack<>();
    ...
    @Test
    public void MulTest() throws ParserException, WorkerException {
        Stack<Double> localStack = new Stack<>();
    ...
    @Test
    public void PlusTest() throws ParserException, WorkerException {
        Stack<Double> localStack = new Stack<>();
    ...
    @Test
    public void SqrtTest() throws ParserException, WorkerException {
        Stack<Double> localStack = new Stack<>();
